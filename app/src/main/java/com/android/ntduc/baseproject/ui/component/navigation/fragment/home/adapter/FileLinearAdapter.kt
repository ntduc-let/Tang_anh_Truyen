...
import com.android.ntduc.baseproject.databinding.ItemDocumentLinearBinding
...
class FileLinearAdapter(
    val context: Context
) : BindingListAdapter<BaseFile, FileLinearAdapter.ItemViewHolder>(diffUtil), DraggableItemAdapter<FileLinearAdapter.ItemViewHolder> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder =
        parent.binding<ItemDocumentLinearBinding>(R.layout.item_document_linear).let(::ItemViewHolder)

    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) =
        holder.bind(getItem(position))

    inner class ItemViewHolder constructor(
        val binding: ItemDocumentLinearBinding
